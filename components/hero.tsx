  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          The{" "}
          <span className="text-[#1f4fa3] font-semibold">Aldi Method</span>{" "}
        ...
        >
          Discover how people are saving on groceries, fresh food, household essentials, and everyday needs.
        </p>
        ...
        >
          <a
            ...
            className="touch-button group inline-flex items-center gap-3 bg-[#1f4fa3] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#14215B] transition-all duration-300 hover:shadow-xl hover:shadow-[#1f4fa3]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
