...
export function CTA() {
  ...
  return (
    <section id="apply" ref={sectionRef} className="pt-10 pb-14 sm:pt-12 sm:pb-16 px-4 bg-card">
      <div className="max-w-4xl mx-auto">
        <div
          className={`relative bg-[#1f4fa3] rounded-3xl p-6 sm:p-10 text-center overflow-hidden transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p
              className={`text-white/90 text-base sm:text-lg mb-6 max-w-xl mx-auto leading-relaxed font-normal transition-all duration-600 ease-out ${
                sectionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
              style={{ transitionDelay: sectionVisible ? "400ms" : "0ms" }}
            >
              Join thousands of shoppers who have already claimed their $750 reward. Your savings are just a few clicks away.
            </p>
            ...
            >
              <a
                href="https://trksy.org/aff_c?offer_id=2843&aff_id=26188"
                target="_blank"
                rel="noopener noreferrer"
                className="touch-button group inline-flex items-center gap-3 bg-white text-[#14215B] px-10 py-5 rounded-full text-lg font-semibold hover:bg-white/95 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
              >
                APPLY NOW
