...
const AFFILIATE_LINK = "https://trksy.org/aff_c?offer_id=2843&aff_id=26188"

const BLUE = "#0B4EA2"
const BLUE_DEEP = "#001E5A"
const BLUE_BRIGHT = "#2E7BD6"
const INK = "#111213"
...
const CATEGORIES = [
  {
    t: "Fresh Produce & Meat",
    d: "Seasonal fruit, vegetables, and butcher-quality cuts.",
    icon: "M12 8c0-2.2 1.8-4 4-4 0 2.2-1.8 4-4 4z M12 8c-3.3 0-6 2.4-6 5.6C6 17.5 8.7 21 12 21s6-3.5 6-7.4C18 10.4 15.3 8 12 8z",
  },
  {
    t: "Pantry & Snacks",
    d: "Everyday staples, coffee, cereal, and treats.",
    icon: "M6 3h12l-1 4H7L6 3z M7 7h10l1 12a2 2 0 01-2 2H8a2 2 0 01-2-2L7 7z M10 12h4",
  },
  {
    t: "ALDI Finds & Seasonal",
    d: "Limited-time middle-aisle deals and holiday picks.",
    icon: "M3 8.5h18v3H3v-3z M4.5 11.5h15V20a1 1 0 01-1 1h-13a1 1 0 01-1-1v-8.5z M12 8.5V21 M12 8.5C10.5 5 7 5 7 6.8c0 1.2 2 1.7 5 1.7z M12 8.5c1.5-3.5 5-3.5 5-1.7 0 1.2-2 1.7-5 1.7z",
  },
  {
    t: "Household & Baby",
    d: "Cleaning supplies, paper goods, diapers, and wipes.",
    icon: "M5 9h9l1 12H4L5 9z M7 9V6.5a2.5 2.5 0 015 0V9 M17 12h3v4h-3z M18.5 16v5",
  },
]
...
const AVATARS = [
  { src: "/avatars/aldi-shopper-1.png", alt: "Smiling woman with dark curly hair in a teal top" },
  { src: "/avatars/aldi-shopper-2.png", alt: "Smiling middle-aged man in a grey henley shirt" },
  { src: "/avatars/aldi-shopper-3.png", alt: "Smiling woman with blonde hair in a denim shirt" },
]
  ...
  return (
    <div className="relative grid grid-cols-[3rem_1fr] md:grid-cols-[1fr_3.5rem_1fr] gap-x-4 md:gap-x-8 items-center pb-6 md:pb-8 last:pb-0">
      <div
        ...
        aria-hidden="true"
      >
        <span className="font-black text-6xl lg:text-7xl leading-none select-none" style={{ color: "#DCE7F5" }}>
          0{index + 1}
        </span>
      </div>
      ...
      <div className="order-1 md:order-2 flex justify-center self-start md:self-center pt-1 md:pt-0">
        <div
          ...
          style={{
            ...
            borderColor: BLUE,
            color: "#FFFFFF",
            boxShadow: "0 8px 22px rgba(11,78,162,.35)",
          }}
        >
          {index + 1}
        </div>
...
export default function AldiRewardLander() {
  ...
  return (
    <div className="min-h-screen bg-white antialiased overflow-x-hidden font-sans" style={{ color: INK }}>
      <style>{`
        ...
        .card-shine { position: absolute; inset: 0; pointer-events: none; background: linear-gradient(115deg, transparent 35%, rgba(11,78,162,0.05) 47%, rgba(255,255,255,0.55) 52%, transparent 65%); background-size: 260% 100%; animation: cardShine 7s ease-in-out infinite; }
        ...
        .cat-spark { position: absolute; top: 16px; right: 18px; color: #0B4EA2; animation: sparkTwinkle 3.4s ease-in-out infinite; }
        ...
        .t-card:hover { transform: translateY(-6px); border-color: rgba(11,78,162,.35); box-shadow: 0 18px 44px rgba(11,78,162,.12); }
        .t-rail-fill { background: linear-gradient(180deg, #2E7BD6, #0B4EA2); }
      ...
      >
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#4F91E0" }} />
        <div className="orb w-80 h-80 top-1/3 -right-20" style={{ backgroundColor: "#001E5A", animationDelay: "-6s" }} />
        ...
        <div className="drifter right-[10%] top-[18%]" style={{ animationDelay: "-3s" }}>
          <Icon
            d="M3 5h2l2.5 9h9L19 7H6 M9 19a1.4 1.4 0 100-2.8 1.4 1.4 0 000 2.8z M16.5 19a1.4 1.4 0 100-2.8 1.4 1.4 0 000 2.8z"
            color="#fff"
            className="w-9 h-9"
          />
        </div>
        ...
        <div className="relative mx-auto max-w-3xl px-6 pt-12 pb-20 md:pt-20 md:pb-24 text-center">
          <div className="text-white">
            ...
            <h1 className="mt-6 font-black tracking-tight leading-[1.05] text-[2rem] min-[368px]:text-[2.3rem] min-[400px]:text-[2.4rem] min-[432px]:text-[2.6rem] min-[464px]:text-[2.8rem] min-[496px]:text-[3rem] min-[528px]:text-[3.2rem] min-[560px]:text-[3.5rem] min-[608px]:text-[3.75rem] sm:text-7xl text-balance">
              {"The ALDI Discounts They Don't Advertise"}
            </h1>
            <p className="mt-6 text-lg md:text-xl text-white/85 max-w-xl mx-auto leading-relaxed text-pretty">
              Discover how shoppers are unlocking hidden discount codes on fresh produce, pantry staples, ALDI Finds, and
      ...
      >
        ...
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#7AB2EC", opacity: 0.35 }} />
        <div
          className="orb w-80 h-80 -bottom-24 -right-16"
          style={{ backgroundColor: "#001E5A", animationDelay: "-5s" }}
        />
