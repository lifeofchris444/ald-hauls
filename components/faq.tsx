...
export function FAQ() {
  ...
  return (
    <section id="faq" ref={sectionRef} className="py-10 sm:py-12 px-4 relative">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="space-y-2">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className={`bg-card border border-border/60 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#1f4fa3]/30 touch-card ${
                sectionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
              }`}
              style={{
            ...
            >
              ...
              >
                <div className="touch-icon flex-shrink-0 w-11 h-11 bg-muted rounded-xl flex items-center justify-center group-hover:bg-[#1f4fa3]/10 transition-colors duration-200">
                  <faq.icon className="w-5 h-5 text-foreground/70 group-hover:text-[#1f4fa3] transition-colors duration-200" strokeWidth={1.5} />
                </div>
                <span className="flex-1 font-semibold text-foreground text-base">
                  {faq.question}
                </span>
                <div className="touch-icon flex-shrink-0 w-9 h-9 bg-muted rounded-full flex items-center justify-center group-hover:bg-[#1f4fa3]/10 transition-colors duration-200">
                  <ChevronDown
                    className={`w-5 h-5 text-foreground/70 group-hover:text-[#1f4fa3] transition-all duration-300 ease-out ${
              ...
              >
                <div className="px-5 pb-5 pt-0 pl-[4.25rem]">
